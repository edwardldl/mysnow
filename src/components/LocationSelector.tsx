...
export default function LocationSelector({
  ...
  return (
    <div className="flex flex-col gap-3 w-full max-w-7xl mx-auto px-4 md:px-8 py-4">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button
          ...
          className={cn(
            "flex items-center justify-center w-9 h-9 rounded-full transition-all duration-300 border",
            isAdding 
              ? "bg-accent-blue border-accent-blue text-white shadow-lg shadow-blue-500/20 rotate-45" 
              : "bg-white/5 border-white/10 text-slate-400 hover:bg-white/10 hover:border-white/20 hover:text-slate-200"
          )}
          title={isAdding ? "Close" : "Add Location"}
        >
